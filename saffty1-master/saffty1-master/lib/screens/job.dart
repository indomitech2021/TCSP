          ...
          child: Column(
            ...
            children: [
              _buildContainer(() {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => JobDetails(id:"0")),
                );  },),
                      ...
                      children: <Widget>[
                        Row(
                          children: [
                            ...
                            SizedBox(width: 8.w),
                            Text('$job_type',style: TextStyle(color: Colors.grey.shade600),),
                          ],
                        ),
                        Row(
                          children: [
                      ...
                      children: <Widget>[
                        Row(
                          children: [
                            ...
                            SizedBox(width: 8.w),
                            Text('$salary',style: TextStyle(color: Colors.grey.shade600)),
                          ],
                        ),
